...
const NavDown = () => {
  ...
  return (
    <>
    {
        ...
        :
        (
            <nav className='transition-all lg:mx-16 lg:p-2 bg-white text-[#516191] flex flex-col lg:flex-row p-4 mx-2 lg:justify-center lg:items-center'>
                ...
                <a href="" className='w-full py-3 lg:w-auto lg:border-none hover:text-pink-700 lg:p-2 uppercase'>Services</a>
            </nav>
        )
    }
