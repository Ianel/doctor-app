...
const Hero = () => {
  return (
    <div id="hero" className='flex lg:flex-row flex-col items-center justify-center lg:justify-end lg:items-center bg-opacity-100 w-full h-screen bg-hero-pattern bg-cover bg-no-repeat bg-center text-white'>
